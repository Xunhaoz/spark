...
growth_rate = GBTClassifier(featuresCol="scaler_features", labelCol="growth_rate")
length_weight = GBTClassifier(featuresCol="scaler_features", labelCol="length_weight")
