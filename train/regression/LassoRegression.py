...
growth_rate = LinearRegression(featuresCol="scaler_features", labelCol="growth_rate", elasticNetParam=1.0, regParam=0.1)
length_weight = LinearRegression(featuresCol="scaler_features", labelCol="length_weight", elasticNetParam=1.0,
                                 regParam=0.1)
...
growth_rate_model.write().overwrite().save(
    "./models/growth_rate_lasso_regression"
)
length_weight_model.write().overwrite().save(
    "./models/length_weight_lasso_regression"
)
