...
growth_rate = FMClassifier(featuresCol="scaler_features", labelCol="growth_rate")
length_weight = FMClassifier(featuresCol="scaler_features", labelCol="length_weight")
