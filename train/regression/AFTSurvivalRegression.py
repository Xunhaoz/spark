...
growth_rate = AFTSurvivalRegression(featuresCol="scaler_features", labelCol="growth_rate")
length_weight = AFTSurvivalRegression(featuresCol="scaler_features", labelCol="length_weight")
