...
growth_rate = GBTRegressor(featuresCol="scaler_features", labelCol="growth_rate")
length_weight = GBTRegressor(featuresCol="scaler_features", labelCol="length_weight")
