...
growth_rate_lr = RandomForestRegressor(featuresCol="scaler_features", labelCol="growth_rate")
length_weight_lr = RandomForestRegressor(featuresCol="scaler_features", labelCol="length_weight")
...
print(growth_rate_model)
print(length_weight_model)
