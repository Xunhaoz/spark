...
growth_rate_lr = GeneralizedLinearRegression(featuresCol="scaler_features", labelCol="growth_rate")
length_weight_lr = GeneralizedLinearRegression(featuresCol="scaler_features", labelCol="length_weight")
