...
growth_rate_lr = LinearRegression(featuresCol="scaler_features", labelCol="growth_rate")
length_weight_lr = LinearRegression(featuresCol="scaler_features", labelCol="length_weight")
