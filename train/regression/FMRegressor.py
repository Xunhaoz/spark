...
from pyspark.ml.regression import FMRegressionModel, FMRegressor
...
growth_rate = FMRegressor(featuresCol="scaler_features", labelCol="growth_rate")
length_weight = FMRegressor(featuresCol="scaler_features", labelCol="length_weight")
